...
A review copy of the story content. This is written for reading outside the game. The ids in brackets match `letters-to-ashfield/js/content.js`; the internal flags are included where a choice changes later content.
