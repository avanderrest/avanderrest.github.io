/* Image Studio's styles: every filter the layer stack can hold, each a function
   over RGBA pixel data, plus the colour maps and the lazy opencv.js loader. */
(function () {
  'use strict';
  ...
  (function loadOpenCV() {
    ...
    s.async = true;
    // if it fails to load, Flat Illustration simply stays unavailable
