...
The sources live in `images/minigames/cottage-diary/reference/` (gitignored) and
the scripts that cut them in `notes/cottage-diary-assets/` (also gitignored). Run
