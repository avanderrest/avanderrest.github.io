...
Three sheets, kept out of the repo in `images/minigames/hollowmarch/reference/`
...
`assets/build/` and `assets/enemy/`; the UI pieces were cut
...
The grass, trees, rocks and road tiles off the map-objects sheet were cut into
`assets/terrain/` for painting the roads onto the board, but nothing ever used them
and they were removed at release (2026-09-24). `slice.py` still cuts them: 67×67 or
so, on the sheet's own 71.4px grid with a 2px inset.
