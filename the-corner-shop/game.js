...
(() => {
  ...
  // ---------- constants ----------
  const SAVE_KEY = 'the-corner-shop-save-v1';
  const SOUND_KEY = 'the-corner-shop-sound';
  // The game lived in corner-shop/ until 2026-09-24; carry its saved keys across once.
  [[SAVE_KEY, 'corner-shop-save-v1'], [SOUND_KEY, 'corner-shop-sound']].forEach(([now, was]) => {
    try {
  ...
  // notes/the-corner-shop-assets/recolour.py. faceSvg still builds a face for
