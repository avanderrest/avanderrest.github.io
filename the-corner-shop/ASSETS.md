...
The sheets live in `images/minigames/the-corner-shop/reference/` (gitignored), and
the scripts that cut them are in `notes/the-corner-shop-assets/`. Re-run any of
...
```sh
python notes/the-corner-shop-assets/plate.py       # room.jpg, counter.png
python notes/the-corner-shop-assets/hud.py         # hud/*.png
python notes/the-corner-shop-assets/slice.py       # goods/*, people/*  (add `contact` for a contact sheet)
python notes/the-corner-shop-assets/recolour.py    # the re-dyed variants; run after slice.py
```
...
paintings in `images/minigames/the-corner-shop/reference/`:
